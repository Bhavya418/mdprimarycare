  ...
  return (
    <section className='relative flex h-[75vh] items-center justify-center sm:justify-start'>
      ...
      <div className='relative z-10 w-full max-w-5xl px-6 text-center sm:max-w-3xl sm:px-10 sm:text-left'>
        <p className='font-open-sans mb-6 text-lg tracking-widest text-white uppercase sm:mb-4 sm:text-base'>
          We Give You The Best!
        </p>
        <h1 className='font-montserrat text-5xl leading-tight font-extrabold text-white sm:text-4xl md:text-5xl lg:text-6xl'>
        ...
        <Link
          ...
          className='font-open-sans mt-10 inline-block rounded border-2 border-white px-8 py-3 text-base font-bold text-white transition hover:bg-white hover:text-teal-600 sm:mt-8 sm:px-8 sm:py-3 sm:text-base'
          target='_blank'
      ...
      <div className='absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 transform flex-col items-center space-y-2 text-white sm:hidden'>
        ...
        <div className='text-center'>
          <p className='font-montserrat text-sm leading-tight font-semibold'>
            2215 Nebraska avenue #2B, Fort Pierce, FL 34950
          </p>
          <p className='font-open-sans text-xs opacity-80'>
            Mon - Sat 8 AM – 5 PM
          </p>
        </div>
      </div>
      ...
      <div className='absolute right-4 bottom-4 z-10 hidden items-center space-x-3 text-white sm:flex md:right-10 md:bottom-6 md:space-x-4'>
        ...
        {/* Address */}
        <div>
          <p className='font-montserrat text-sm leading-tight font-semibold md:text-lg'>
            2215 Nebraska avenue #2B, Fort Pierce, FL 34950
          </p>
          <p className='font-open-sans text-xs opacity-80 md:text-sm'>
            Mon - Sat 8 AM – 5 PM
          </p>
        </div>
      </div>
