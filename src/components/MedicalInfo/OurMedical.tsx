    ...
    <section className='bg-white py-16 sm:py-24'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='flex flex-col items-stretch gap-12 lg:flex-row lg:gap-16'>
          {/* Mobile Image Section - Shows first on mobile */}
          <div className='flex justify-center lg:hidden'>
            <div className='relative h-80 w-80 overflow-hidden rounded-2xl shadow-2xl sm:h-96 sm:w-96'>
              <Image
          ...
          {/* Desktop Image Section - Right Column */}
            ...
            <div className='relative min-h-[500px] w-full'>
              ...
              <div className='relative z-10 h-full w-full p-8'>
                <div className='relative h-full min-h-[400px] w-full overflow-hidden shadow-2xl'>
                  ...
                  {/* Experience Card (positioned at bottom center) */}
